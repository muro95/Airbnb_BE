...
public class HouseEntity {
    ...
    public HouseEntity(String houseName, Long category, String picture, String address, Long bedroomNumber, Long bathroomNumber, String description, Long price, Long area,Status status, Long user) {
